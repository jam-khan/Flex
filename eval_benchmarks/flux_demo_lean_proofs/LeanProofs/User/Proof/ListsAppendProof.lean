...
import LeanProofs.Flux.VC.ListsAppend
open Classical
...
end ListsAppendQualifs

open ListsAppendQualifs

set_option maxHeartbeats 5000000
#time def ListsAppend_proof : ListsAppend := by
  unfold ListsAppend
