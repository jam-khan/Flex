...
import LeanProofs.Flux.VC.ListsGetNth
open Classical
...
end ListsGetNthQualifs

open ListsGetNthQualifs

set_option maxHeartbeats 5000000
#time def ListsGetNth_proof : ListsGetNth := by
  unfold ListsGetNth
