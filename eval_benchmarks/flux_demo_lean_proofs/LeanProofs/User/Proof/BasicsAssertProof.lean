...
import LeanProofs.Flux.VC.BasicsAssert
open Classical
...
end BasicsAssertQualifs

open BasicsAssertQualifs

set_option maxHeartbeats 5000000
#time def BasicsAssert_proof : BasicsAssert := by
  unfold BasicsAssert
