...
import LeanProofs.Flux.VC.DemoSigmoid
open Classical
...
end DemoSigmoidQualifs

open DemoSigmoidQualifs

set_option maxHeartbeats 5000000
#time def DemoSigmoid_proof : DemoSigmoid := by
  unfold DemoSigmoid
