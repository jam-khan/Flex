...
import LeanProofs.Flux.VC.BasicsTestOwnership
open Classical
...
namespace BasicsTestOwnershipQualifs
...
end BasicsTestOwnershipQualifs

open BasicsTestOwnershipQualifs

set_option maxHeartbeats 5000000
#time def BasicsTestOwnership_proof : BasicsTestOwnership := by
  unfold BasicsTestOwnership
