...
import LeanProofs.Flux.VC.VectorsTestRvec
open Classical
...
namespace VectorsTestRvecQualifs
...
end VectorsTestRvecQualifs

open VectorsTestRvecQualifs

set_option maxHeartbeats 5000000
#time def VectorsTestRvec_proof : VectorsTestRvec := by
  unfold VectorsTestRvec
