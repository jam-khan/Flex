...
import LeanProofs.Flux.VC.DemoDecrMut
open Classical
...
end DemoDecrMutQualifs

open DemoDecrMutQualifs

set_option maxHeartbeats 5000000
#time def DemoDecrMut_proof : DemoDecrMut := by
  unfold DemoDecrMut
