...
import LeanProofs.Flux.VC.KmeansAssert
open Classical
...
end KmeansAssertQualifs

open KmeansAssertQualifs

set_option maxHeartbeats 5000000
#time def KmeansAssert_proof : KmeansAssert := by
  unfold KmeansAssert
