...
import LeanProofs.Flux.VC.ListsMappend
open Classical
...
end ListsMappendQualifs

open ListsMappendQualifs

set_option maxHeartbeats 5000000
#time def ListsMappend_proof : ListsMappend := by
  unfold ListsMappend
