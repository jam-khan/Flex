...
namespace StatsNoopInstrumentationPushSyscallResultQualifs
...
end StatsNoopInstrumentationPushSyscallResultQualifs

open StatsNoopInstrumentationPushSyscallResultQualifs

set_option maxHeartbeats 5000000
#time def StatsNoopInstrumentationPushSyscallResult_proof : StatsNoopInstrumentationPushSyscallResult := by
  unfold StatsNoopInstrumentationPushSyscallResult
