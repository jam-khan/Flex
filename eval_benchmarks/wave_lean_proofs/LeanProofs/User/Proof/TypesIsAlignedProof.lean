...
import LeanProofs.Flux.VC.TypesIsAligned
open Classical
...
namespace TypesIsAlignedQualifs
...
end TypesIsAlignedQualifs

open TypesIsAlignedQualifs

set_option maxHeartbeats 5000000
#time def TypesIsAligned_proof : TypesIsAligned := by
  unfold TypesIsAligned
