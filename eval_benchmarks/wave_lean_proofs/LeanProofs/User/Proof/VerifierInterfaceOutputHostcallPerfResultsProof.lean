...
namespace VerifierInterfaceOutputHostcallPerfResultsQualifs
...
end VerifierInterfaceOutputHostcallPerfResultsQualifs

open VerifierInterfaceOutputHostcallPerfResultsQualifs

set_option maxHeartbeats 5000000
#time def VerifierInterfaceOutputHostcallPerfResults_proof : VerifierInterfaceOutputHostcallPerfResults := by
  unfold VerifierInterfaceOutputHostcallPerfResults
