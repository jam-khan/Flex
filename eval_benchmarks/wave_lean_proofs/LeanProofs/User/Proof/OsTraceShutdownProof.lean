...
namespace OsTraceShutdownQualifs
...
end OsTraceShutdownQualifs

open OsTraceShutdownQualifs

set_option maxHeartbeats 5000000
#time def OsTraceShutdown_proof : OsTraceShutdown := by
  unfold OsTraceShutdown
