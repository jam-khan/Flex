...
import LeanProofs.Flux.VC.OsTraceFstat
open Classical
...
end OsTraceFstatQualifs

open OsTraceFstatQualifs

set_option maxHeartbeats 5000000
#time def OsTraceFstat_proof : OsTraceFstat := by
  unfold OsTraceFstat
