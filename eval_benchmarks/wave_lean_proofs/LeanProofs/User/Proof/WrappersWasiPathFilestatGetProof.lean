...
import LeanProofs.Flux.VC.WrappersWasiPathFilestatGet
open Classical
...
namespace WrappersWasiPathFilestatGetQualifs
...
end WrappersWasiPathFilestatGetQualifs

open WrappersWasiPathFilestatGetQualifs

set_option maxHeartbeats 5000000
#time def WrappersWasiPathFilestatGet_proof : WrappersWasiPathFilestatGet := by
  unfold WrappersWasiPathFilestatGet
