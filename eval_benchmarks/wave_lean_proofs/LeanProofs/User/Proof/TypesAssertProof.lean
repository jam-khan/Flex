...
import LeanProofs.Flux.VC.TypesAssert
open Classical
...
end TypesAssertQualifs

open TypesAssertQualifs

set_option maxHeartbeats 5000000
#time def TypesAssert_proof : TypesAssert := by
  unfold TypesAssert
