...
namespace WrappersWasiPathCreateDirectoryQualifs
...
end WrappersWasiPathCreateDirectoryQualifs

open WrappersWasiPathCreateDirectoryQualifs

set_option maxHeartbeats 5000000
#time def WrappersWasiPathCreateDirectory_proof : WrappersWasiPathCreateDirectory := by
  unfold WrappersWasiPathCreateDirectory
