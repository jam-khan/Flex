...
import LeanProofs.Flux.VC.OsTraceClose
open Classical
...
end OsTraceCloseQualifs

open OsTraceCloseQualifs

set_option maxHeartbeats 5000000
#time def OsTraceClose_proof : OsTraceClose := by
  unfold OsTraceClose
