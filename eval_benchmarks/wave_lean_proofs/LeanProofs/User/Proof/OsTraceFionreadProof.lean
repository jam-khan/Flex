...
import LeanProofs.Flux.VC.OsTraceFionread
open Classical
...
namespace OsTraceFionreadQualifs
...
end OsTraceFionreadQualifs

open OsTraceFionreadQualifs

set_option maxHeartbeats 5000000
#time def OsTraceFionread_proof : OsTraceFionread := by
  unfold OsTraceFionread
