...
import LeanProofs.Flux.VC.OsTraceSync
open Classical
...
end OsTraceSyncQualifs

open OsTraceSyncQualifs

set_option maxHeartbeats 5000000
#time def OsTraceSync_proof : OsTraceSync := by
  unfold OsTraceSync
