...
namespace OsPlatformTraceAllocateQualifs
...
end OsPlatformTraceAllocateQualifs

open OsPlatformTraceAllocateQualifs

set_option maxHeartbeats 5000000
#time def OsPlatformTraceAllocate_proof : OsPlatformTraceAllocate := by
  unfold OsPlatformTraceAllocate
