...
import LeanProofs.Flux.VC.OsTracePread
open Classical
...
end OsTracePreadQualifs

open OsTracePreadQualifs

set_option maxHeartbeats 5000000
#time def OsTracePread_proof : OsTracePread := by
  unfold OsTracePread
