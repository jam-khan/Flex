...
import LeanProofs.Flux.VC.VecVecGetMut
open Classical
...
end VecVecGetMutQualifs

open VecVecGetMutQualifs

set_option maxHeartbeats 5000000
#time def VecVecGetMut_proof : VecVecGetMut := by
  unfold VecVecGetMut
