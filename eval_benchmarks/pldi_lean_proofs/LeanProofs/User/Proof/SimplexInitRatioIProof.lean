...
namespace SimplexInitRatioIQualifs
...
end SimplexInitRatioIQualifs

open SimplexInitRatioIQualifs

set_option maxHeartbeats 5000000
#time def SimplexInitRatioI_proof : SimplexInitRatioI := by
  unfold SimplexInitRatioI
