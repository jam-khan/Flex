...
namespace BucketMapHashKeyQualifs
...
end BucketMapHashKeyQualifs

open BucketMapHashKeyQualifs

set_option maxHeartbeats 5000000
#time def BucketMapHashKey_proof : BucketMapHashKey := by
  unfold BucketMapHashKey
