...
namespace BucketMapThmNewWithCapacityQualifs
...
end BucketMapThmNewWithCapacityQualifs

open BucketMapThmNewWithCapacityQualifs

set_option maxHeartbeats 5000000
#time def BucketMapThmNewWithCapacity_proof : BucketMapThmNewWithCapacity := by
