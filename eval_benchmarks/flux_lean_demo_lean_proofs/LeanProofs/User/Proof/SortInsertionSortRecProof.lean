...
namespace SortInsertionSortRecQualifs
...
end SortInsertionSortRecQualifs

open SortInsertionSortRecQualifs

set_option maxHeartbeats 5000000
#time def SortInsertionSortRec_proof : SortInsertionSortRec := by
